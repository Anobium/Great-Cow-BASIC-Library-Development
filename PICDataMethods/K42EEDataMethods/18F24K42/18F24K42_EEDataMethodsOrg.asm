...
FLASHADDR_H	EQU	19
FLASHADDR_U	EQU	20
FLASH_READBYTE_K42	EQU	22
FLASH_READWORD_K42	EQU	23
FLASH_READWORD_K42_H	EQU	24
FLASH_WRITEBLOCK_K42	EQU	25
MYBYTE	EQU	26
MYFLASHADDRESS	EQU	27
MYFLASHADDRESS_E	EQU	30
MYFLASHADDRESS_H	EQU	28
MYFLASHADDRESS_U	EQU	29
MYWORD	EQU	31
MYWORD_H	EQU	32
NVMADRH	EQU	33
READLOOP	EQU	34
...
SYSBYTETEMPX	EQU	0
SYSEEADDRESS	EQU	36
SYSEEADDRESS_H	EQU	37
SYSEEPROMADDRESS	EQU	38
SYSEEPROMADDRESS_H	EQU	39
SYSFLASHRDBUFPTRHANDLER	EQU	40
SYSFLASHRDBUFPTRHANDLER_H	EQU	41
SYSFLASHWRBUFPTRHANDLER	EQU	42
SYSFLASHWRBUFPTRHANDLER_H	EQU	43
SYSLONGTEMPA	EQU	5
...
;FLASH_WriteWord_K42( myFlashAddress, EEDataBuffer, 0xAA55 )
	...
	movlw	85
	movwf	EEDATAWORD,BANKED
	movlw	170
	movwf	EEDATAWORD_H,BANKED
	rcall	FLASH_WRITEWORD_K42
...
;FLASH_WriteByte_K42( 0x003000, EEDataBuffer, 0x55 )
	clrf	FLASHADDR,BANKED
	movlw	48
	movwf	FLASHADDR_H,BANKED
	clrf	FLASHADDR_U,BANKED
	clrf	FLASHADDR_E,BANKED
	movlw	low EEDATABUFFER
	movwf	SysFLASHRDBUFPTRHandler,BANKED
	movlw	high EEDATABUFFER
	movwf	SysFLASHRDBUFPTRHandler_H,BANKED
...
;FLASH_WriteByte_K42( flashAddr , flashRdBufPtr, EEDataword_h )
	movff	SysFLASHRDBUFPTRHandler,SysFLASHRDBUFPTRHandler
	movff	SysFLASHRDBUFPTRHandler_H,SysFLASHRDBUFPTRHandler_H
...
;FLASH_WriteByte_K42( flashAddr+1 , flashRdBufPtr, EEDataword )
	...
	movff	SysFLASHRDBUFPTRHandler,SysFLASHRDBUFPTRHandler
	movff	SysFLASHRDBUFPTRHandler_H,SysFLASHRDBUFPTRHandler_H
	movff	EEDATAWORD,EEDATABYTE
	rcall	FLASH_WRITEBYTE_K42
	movff	EEDATABYTE,EEDATAWORD
