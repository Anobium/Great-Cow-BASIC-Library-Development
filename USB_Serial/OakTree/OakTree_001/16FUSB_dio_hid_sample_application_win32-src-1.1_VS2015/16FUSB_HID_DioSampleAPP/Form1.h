...
#pragma region Windows Form Designer generated code
			 ...
			 void InitializeComponent(void)
			 {
				 ...
				 this->comboBox1->Items->AddRange(gcnew cli::array< System::Object^  >(5) { L"115200", L"57600", L"38400", L"19200", L"9600" });
				 ...
				 this->comboBox2->Items->AddRange(gcnew cli::array< System::Object^  >(2) { L"RTS HIGH", L"RTS LOW" });
				 this->comboBox2->Location = System::Drawing::Point(18, 18);
				 this->comboBox2->Name = L"comboBox2";
				 this->comboBox2->Size = System::Drawing::Size(105, 21);
				 this->comboBox2->TabIndex = 0;
				 this->comboBox2->SelectedIndexChanged += gcnew System::EventHandler(this, &Form1::comboBox2_SelectedIndexChanged_1);
				 ...
				 this->Name = L"Form1";
				 this->Text = L"16FUSB - HID Application #029";
