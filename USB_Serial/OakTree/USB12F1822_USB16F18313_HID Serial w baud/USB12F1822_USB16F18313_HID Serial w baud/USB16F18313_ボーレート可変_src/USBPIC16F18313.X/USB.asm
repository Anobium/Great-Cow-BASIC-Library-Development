...
;*****************************************************************************************************
	...
	__CONFIG _CONFIG2, _MCLRE_OFF & _PWRTE_ON & _WDTE_OFF & _LPBOREN_OFF & _BOREN_OFF & _BORV_HIGH & _PPS1WAY_OFF & _STVREN_OFF
...
;       +-----------+-------+---------------------+    +-------+-------+---------------+
;       |   0x20    |  any  | Set RTS High        |
;       +-----------+-------+---------------------+
;       |   0x10    |  any  | Set RTS Low         |
;       +-----------+-------+---------------------+
;       |   0x00    | SData | Sending Serial Data |    Default: 8bit, No parity, 1 stop bit, 115200bps, RTS=High
;       +-----------+-------+---------------------+   ===========================================================
;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
Configurar
	movlw	PIE0				;+ FSR1=PIE0
	movwf	FSR1L				;+
;	bsf	INTCON,INTEDG			;+ INT=Rising edge

	movlb	.18				;+ Clock
	movlw	B'00000101'			;+ 16x2 --> 12x2
	movwf	OSCFRQ				;+ 24MHz
	movlw	B'00111100'			;+ Adjust Freq
	movwf	OSCTUNE				;+
...
ProcessOut				; Custom code goes here
	...
	goto	Set_BR
	btfsc	Recibido_2,5		;!(Recibido_2 = 0x20) ?
	goto	Set_RTS_High
	btfsc	Recibido_2,4		;!(Recibido_2 = 0x10) ?
	goto	Set_RTS_Low
