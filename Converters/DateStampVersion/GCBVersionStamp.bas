' A program to date stamp program
...
dim shared as byte  result
dim as integer dotPointer,c,nargs
...
main:
      ...
      if nargs-1 = 0 then
         print "> Help for GCBVersionStamp"
         print ">"
         print ">         A tool to create a date stamp for Great Cow BASIC"
         print ">"
         print ">         Command line parameters"
         print ">         GCBDateStamp filename.cnt"
         print ">         "
         print ">         The output will be a method with the extension GCB"
         print ">"
      ...
      if isValid ( params(1) ) then
         ...
         Put #ffilehandle, , "'Great Cow BASIC Date Stamp Converter v1.06":Put #ffilehandle, , chr(13) : Put #ffilehandle, , chr(10)

'         Put #ffilehandle, , "        dim buildString as string * 5 ":Put #ffilehandle, , chr(13) : Put #ffilehandle, , chr(10)
'         Put #ffilehandle, , "        dim buildtimeString  as string * 19    ":Put #ffilehandle, , chr(13) : Put #ffilehandle, , chr(10)
'         Put #ffilehandle, , "        Sub _MyInit  ":Put #ffilehandle, , chr(13) : Put #ffilehandle, , chr(10)
'         Put #ffilehandle, , "            buildString=" & Chr(34) & VersionData & Chr(34) :Put #ffilehandle, , chr(13) : Put #ffilehandle, , chr(10)
'         Put #ffilehandle, , "            buildtimeString="&chr(34)&Date()&" "&Time()&chr(34)   :Put #ffilehandle, , chr(13) : Put #ffilehandle, , chr(10)
'         Put #ffilehandle, , "        End Sub ":Put #ffilehandle, , chr(13) : Put #ffilehandle, , chr(10)
      ...
      print "Great Cow BASIC build version utility (1.06)...  Build " & str(VersionData)
