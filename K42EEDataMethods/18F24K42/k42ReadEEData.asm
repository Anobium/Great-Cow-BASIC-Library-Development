...
FLASHADDR_H	EQU	20
FLASHADDR_U	EQU	21
FLASH_READBYTE_K42	EQU	23
FLASH_WRITEBLOCK_K42	EQU	24
MYBYTE	EQU	25
MYFLASHADDRESS	EQU	26
MYFLASHADDRESS_E	EQU	29
MYFLASHADDRESS_H	EQU	27
MYFLASHADDRESS_U	EQU	28
NVMADRH	EQU	30
SYSBITVAR0	EQU	31
SYSBYTETEMPA	EQU	5
SYSBYTETEMPB	EQU	9
SYSBYTETEMPX	EQU	0
SYSEEADDRESS	EQU	32
SYSEEADDRESS_H	EQU	33
SYSEEPROMADDRESS	EQU	34
SYSEEPROMADDRESS_H	EQU	35
SYSFLASHRDBUFPTRHANDLER	EQU	36
SYSFLASHRDBUFPTRHANDLER_H	EQU	37
SYSFLASHWRBUFPTRHANDLER	EQU	38
SYSFLASHWRBUFPTRHANDLER_H	EQU	39
SYSLONGTEMPA	EQU	5
...
;mybyte = FLASH_ReadByte_K42  ( myFlashAddress )
	movff	MYFLASHADDRESS,_FLASHADDR
	movff	MYFLASHADDRESS_H,_FLASHADDR_H
	movff	MYFLASHADDRESS_U,_FLASHADDR_U
	movff	MYFLASHADDRESS_E,_FLASHADDR_E
...
;TBLPTRU = _flashAddr_u
	movffl	_FLASHADDR_U,TBLPTRU
;TBLPTRH = _flashAddr_h
	movffl	_FLASHADDR_H,TBLPTRH
;TBLPTRL = _flashAddr
	movffl	_FLASHADDR,TBLPTRL
;TBLRD*
	tblrd*
;NOP
	nop
...
;flashRdBufPtr(writeloop) = FLASH_ReadByte_K42(blockStartAddr+ writeloop )
	...
	movwf	_FLASHADDR,BANKED
	movlw	0
	addwfc	BLOCKSTARTADDR_H,W,BANKED
	movwf	_FLASHADDR_H,BANKED
	movlw	0
	addwfc	BLOCKSTARTADDR_U,W,BANKED
	movwf	_FLASHADDR_U,BANKED
	movlw	0
	addwfc	BLOCKSTARTADDR_E,W,BANKED
	movwf	_FLASHADDR_E,BANKED
	rcall	FN_FLASH_READBYTE_K42
	movf	WRITELOOP,W,BANKED
