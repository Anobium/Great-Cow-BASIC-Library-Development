...
#script
  ...
  If GLCD_TYPE = GLCD_TYPE_ILI9341 Then
     ...
     #include <My_Feb_19_glcd_ili9341.h>
...
''''
Sub GLCDPrint(In PrintLocX as word, In PrintLocY as word, in LCDPrintData as string, In LineColour as word, in sizechar as byte )
  Dim GLCDPrintLoc as word
  Dim GLCDFntDefaultSize_prec as Word

  GLCDFntDefaultSize_prec=GLCDFntDefaultSize
  GLCDPrintLen = LCDPrintData(0)
  If GLCDPrintLen = 0 Then Exit Sub
  ...
  Next
      ...
      GLCDFontWidth = OldGLCDFontWidth
  #endif
  GLCDFntDefaultSize=GLCDFntDefaultSize_prev
