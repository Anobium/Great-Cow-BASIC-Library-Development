...
Sub Init_XPT2046 (Optional In precision = PREC_EXTREME)
    ...
    DIR XPT2046_CS  OUT
      ...
      ' harware SPI mode
      'SPIMode MasterFast, 0			'************DELETED for 18F45K42!
    #endif
...
'sertxd(1,"XPT2046OutByte=",XPT2046OutByte,0)
  #endif
...
Sub GetXY_XPT2046 (out XTouchPoint_XPT2046 as word, out YTouchPoint_XPT2046 as word )
    ...
    dim XTouchPoint_XPT2046, YTouchPoint_XPT2046 as Word
    dim NewXTouchPoint_XPT2046, NewYTouchPoint_XPT2046 as byte   '+++++++++
    dim XTouchPoint_XPT2046raw, YTouchPoint_XPT2046Raw as word
    dim Current_GLCD_WIDTH, Current_GLCD_HEIGHT as word
...
'sertxd(1,"Xraw=",XTouchPoint_XPT2046,0)
'sertxd(0,", Yraw=",YTouchPoint_XPT2046,0)
'sertxd(0,"XPT2046_Xmin=",XPT2046_Xmin,0)
'sertxd(0,", XPT2046_Xmax=",XPT2046_Xmax,0)
'sertxd(1,"Current_GLCD_WIDTH=",Current_GLCD_WIDTH,0)

    'Scale to calibration SCALE is a GCB routine
