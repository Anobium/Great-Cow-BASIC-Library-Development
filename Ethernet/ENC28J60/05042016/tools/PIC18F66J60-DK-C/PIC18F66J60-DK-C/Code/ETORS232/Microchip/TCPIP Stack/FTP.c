...
#define FTP_TIMEOUT                     (TICK)((TICK)180u * TICK_SECOND)
...
static ROM char *FTPResponseString[] =
{
	...
	"425 Can't create data socket.  Increase MAX_TCP_SOCKETS.\r\n",	//FTP_RESP_DATA_NO_SOCKET
    "200 Ok\r\n"                        // FTP_RESP_OK
};
...
static BOOL PutFile(void)
{
    ...
    case SM_FTP_CMD_IDLE:
        ...
        else
        {
            ...
            FTPDataSocket   = TCPConnect(&TCPGetRemoteInfo(FTPSocket)->remote, FTPDataPort.Val);
