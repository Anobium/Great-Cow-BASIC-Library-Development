...
/*                   kZGRegDomainSpain    Available Channels: 10 - 11    */
/*                   kZGRegDomainFrance   Available Channels: 10 - 13    */
 ...
 */
	...
	#define END_OF_TCP_SOCKET_TYPES
		...
		} TCPSocketInitializer[] =
		{
			...
			{TCP_PURPOSE_UART_2_TCP_BRIDGE, TCP_ETH_RAM, 1200, 1200},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 1200, 1200},
			{TCP_PURPOSE_HTTP_SERVER, TCP_ETH_RAM, 1200, 1200},
			{TCP_PURPOSE_DEFAULT, TCP_ETH_RAM, 1200, 1200},
...
// -- SNMP Options -------------------------------------------------------
	...
	#define SNMP_MAX_COMMUNITY_SUPPORT	(3)
