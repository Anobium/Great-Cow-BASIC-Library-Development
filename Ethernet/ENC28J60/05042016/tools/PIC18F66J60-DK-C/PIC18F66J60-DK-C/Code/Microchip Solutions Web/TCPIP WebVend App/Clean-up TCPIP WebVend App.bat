...
del "a.out" /f /q
rmdir "TempOBJ" /s /q
rmdir "Objects - TCPIP WebVend App-C18" /s /q
rmdir "Objects - TCPIP WebVend App-C30" /s /q
rmdir "Objects - TCPIP WebVend App-C32" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - TCPIP WebVend App-C18" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - TCPIP WebVend App-C30" /s /q
rmdir "..\Microchip\TCPIP Stack\Objects - TCPIP WebVend App-C32" /s /q
