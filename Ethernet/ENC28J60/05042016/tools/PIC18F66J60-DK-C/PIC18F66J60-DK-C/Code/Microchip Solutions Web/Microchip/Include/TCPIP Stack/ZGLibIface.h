...
#define _ZGLIBIFACE_H_
  ...
  #define kLibMgrCxtBufLen    128

  #ifdef ZG_RAW_DRIVER
     /* request and confirm must be lockstep */
     #define ZG_LIB_MGMT_Q_SIZE 1
  #else
  ...
  #define  ZG_LIBRARY_LIST						                                \
    ...
    {                                                                           \
      ...
      {                                                                         \
        ZG_COMPLETE_LIST                                                        \
        default:                                                                \
           ZGSYS_MODULE_ASSERT(1, (ROM FAR char*) "DispatchComp");              \
      }                                                                         \
    }
    ...
    {                                                                           \
      ...
      {                                                                         \
        ZG_REQUEST_LIST                                                         \
        default:                                                                \
           ZGSYS_MODULE_ASSERT(1, (ROM FAR char*) "DispatchReq");               \
      }                                                                         \
      return( retValue );                                                       \
    }
    ...
    {                                                                           \
      ...
      {                                                                         \
        ZG_NEXT_LIST                                                            \
        default:                                                                \
           ZGSYS_MODULE_ASSERT(1, (ROM FAR char*) "DispatchNext");              \
      }																	        \
      return ( retValue );                                                      \
    }
  ...
  #undef ZG_LIB_PROTO
    ...
    {																			    \
        ...
        {                                                                           \
            ZG_LIBRARY_LIST                                                         \
            default:                                                                \
                 ZGSYS_MODULE_ASSERT(1, (ROM FAR char*) "LibAPI");                  \
        }                                                                           \
        return ( retValue );                                                        \
    }
...
{                                                                                       \
    ...
    {                                                                                   \
       ZG_INDICATE_LIST													                \
       default:                                                                         \
          ZGSYS_MODULE_ASSERT(1, (ROM FAR char*)"Indicate");                            \
    }                                                                                   \
}
