...
typedef enum _BSD_SCK_STATE
{
    SKT_CLOSED,   // Socket closed state
    SKT_CREATED, // Socket created state
    SKT_BOUND,   // Socket bound state
    SKT_LISTEN,  // Socket listen state
    SKT_IN_PROGRESS, //Socket cnx in progress state
    SKT_READY,  //Socket ready state
    SKT_ARP_RESOLVE, //Socket ARP resolve state
    SKT_ARP_VERIFY, //Socket ARP verify state
    SKT_EST  // Socket established state.
} BSD_SCK_STATE; // Berkeley socket states
