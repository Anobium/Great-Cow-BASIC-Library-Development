...
// Define your own board hardware profile here
	...
	#define LED2_IO				(LATEbits.LATE4)
	#define LED3_TRIS			(TRISEbits.TRISE5)
	#define LED3_IO				(LATEbits.LATE5)
	...
	#define LED6_TRIS			(TRISEbits.TRISE4)
	#define LED6_IO				(LATEbits.LATE4)
	#define LED7_TRIS			(TRISEbits.TRISE5)
	#define LED7_IO				(LATEbits.LATE5)
	...
	// 25LC256 I/O pins
	#define EEPROM_CS_TRIS		(TRISCbits.TRISC1)
