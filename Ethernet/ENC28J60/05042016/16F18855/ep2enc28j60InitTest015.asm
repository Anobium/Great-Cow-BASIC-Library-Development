...
MAXLEN_H	EQU	96
MYDEBUGCOUNT	EQU	97
MYDEBUGCOUNT_H	EQU	98
MYDEBUGCOUNT_U	EQU	99
MYDEBUGCOUNT_E	EQU	100
NEXTPACKETPTR	EQU	101
NEXTPACKETPTR_H	EQU	102
NUMBITS	EQU	103
OLDPACKETCOUNTERIN	EQU	104
OLDPACKETCOUNTERIN_H	EQU	105
OLDPACKETCOUNTERIN_U	EQU	106
OLDPACKETCOUNTERIN_E	EQU	107
OLDPACKETCOUNTEROUT	EQU	108
OLDPACKETCOUNTEROUT_H	EQU	109
OLDPACKETCOUNTEROUT_U	EQU	110
OLDPACKETCOUNTEROUT_E	EQU	111
OUTVALUETEMP	EQU	125
PACKETCOUNTERIN	EQU	160
PACKETCOUNTERIN_H	EQU	161
PACKETCOUNTERIN_U	EQU	162
PACKETCOUNTERIN_E	EQU	163
PACKETCOUNTEROUT	EQU	164
PACKETCOUNTEROUT_H	EQU	165
PACKETCOUNTEROUT_U	EQU	166
PACKETCOUNTEROUT_E	EQU	167
PACKETLENGTH	EQU	126
PACKETLENGTH_H	EQU	127
PCKTLEN	EQU	168
PCKTLEN_H	EQU	169
PHYREGADDR	EQU	171
PREVIOUS_NEXTPACKETPTR	EQU	172
PREVIOUS_NEXTPACKETPTR_H	EQU	173
PRINTLEN	EQU	174
RESULT	EQU	175
RESULT_H	EQU	176
RESULT16	EQU	177
...
SYSLONGDIVMULTA	EQU	198
SYSLONGDIVMULTA_H	EQU	199
SYSLONGDIVMULTA_U	EQU	200
SYSLONGDIVMULTA_E	EQU	201
SYSLONGDIVMULTB	EQU	202
SYSLONGDIVMULTB_H	EQU	203
SYSLONGDIVMULTB_U	EQU	204
SYSLONGDIVMULTB_E	EQU	205
SYSLONGDIVMULTX	EQU	206
SYSLONGDIVMULTX_H	EQU	207
SYSLONGDIVMULTX_U	EQU	208
SYSLONGDIVMULTX_E	EQU	209
SYSPRINTBUFFLEN	EQU	210
SYSPRINTTEMP	EQU	211
SYSSTRDATA	EQU	212
SYSSTRINGTEMP	EQU	213
SYSVALTEMP	EQU	214
SYSVALTEMP_H	EQU	215
StringPointer	EQU	216
SysArrayTemp1	EQU	217
SysArrayTemp2	EQU	218
SysFnBYTE1	EQU	219
SysMACADDRHandler	EQU	220
SysMACADDRHandler_H	EQU	221
SysPRINTDATAHandler	EQU	222
SysPRINTDATAHandler_H	EQU	223
...
SysTemp3	EQU	234
TEMP	EQU	235
T_UDP_DESTPORT	EQU	236
T_UDP_DESTPORT_H	EQU	237
...
;HSerPrintCRLF 2
	...
	call	HSERPRINTCRLF
	pagesel	$
;HserPrint "ENC28J60 Ethernet Driver 016" : HSerPrintCRLF
...
;OldpacketCounterIn = packetCounterIn
	banksel	PACKETCOUNTERIN
	movf	PACKETCOUNTERIN,W
	banksel	OLDPACKETCOUNTERIN
	movwf	OLDPACKETCOUNTERIN
	banksel	PACKETCOUNTERIN_H
	movf	PACKETCOUNTERIN_H,W
	banksel	OLDPACKETCOUNTERIN_H
	movwf	OLDPACKETCOUNTERIN_H
	banksel	PACKETCOUNTERIN_U
	movf	PACKETCOUNTERIN_U,W
	banksel	OLDPACKETCOUNTERIN_U
	movwf	OLDPACKETCOUNTERIN_U
	banksel	PACKETCOUNTERIN_E
	movf	PACKETCOUNTERIN_E,W
	banksel	OLDPACKETCOUNTERIN_E
	movwf	OLDPACKETCOUNTERIN_E
;OldpacketCounterOut = packetCounterOut
	banksel	PACKETCOUNTEROUT
	movf	PACKETCOUNTEROUT,W
	banksel	OLDPACKETCOUNTEROUT
	movwf	OLDPACKETCOUNTEROUT
	banksel	PACKETCOUNTEROUT_H
	movf	PACKETCOUNTEROUT_H,W
	banksel	OLDPACKETCOUNTEROUT_H
	movwf	OLDPACKETCOUNTEROUT_H
	banksel	PACKETCOUNTEROUT_U
	movf	PACKETCOUNTEROUT_U,W
	banksel	OLDPACKETCOUNTEROUT_U
	movwf	OLDPACKETCOUNTEROUT_U
	banksel	PACKETCOUNTEROUT_E
	movf	PACKETCOUNTEROUT_E,W
	banksel	OLDPACKETCOUNTEROUT_E
...
;Hulp2 = Hulp2 + 34
;HSerPrint "Packet Length "
;HSerPrint hulp2
;HSerPrintCRLF
;dim xx as word
;for xx= 1 to hulp2
;HSerPrint hex(etherbuffer(xx))
;HSerPrint ", "
;next
;HSerPrintCRLF
;ENC28J60_Setipaddrs
	...
	pagesel	$
;HSerPrint T_udp_srcport0
;HSerSend 9
;HSerPrint T_udp_destport0
;HSerPrintCRLF
;HSerPrint T_udp_srcport1
;HSerSend 9
;HSerPrint T_udp_destport1
;HSerPrintCRLF
