...
;etherbuffer(20) = 0x00
	clrf	SYSETHERBUFFER_20
;etherbuffer(21) = 0x06
	movlw	6
	movwf	SYSETHERBUFFER_21
;etherbuffer(22) = 0x04
	movlw	4
	movwf	SYSETHERBUFFER_22
;etherbuffer(23) = 0x00
	clrf	SYSETHERBUFFER_23
;etherbuffer(24) = 0x01
	movlw	1
...
;etherbuffer(45) = 0x00 'padding
	clrf	SYSETHERBUFFER_45
;etherbuffer(46) = 0x00
	clrf	SYSETHERBUFFER_46
;etherbuffer(47) = 0x00
