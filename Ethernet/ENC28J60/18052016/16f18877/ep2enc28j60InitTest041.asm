...
ENC_MACADDSYSLOG	EQU	9027
ENC_NEXTPACKETPTR	EQU	56
ENC_NEXTPACKETPTR_H	EQU	57
ENC_OUTBYTE	EQU	58
ENC_OUTBYTE1	EQU	59
ENC_OUTBYTE2	EQU	60
ENC_SNTPSERVERADDR	EQU	9022
ENC_SYSLOGSERVERADDR	EQU	9017
ENDPTR	EQU	61
ENDPTR_H	EQU	62
...
SYSENC_MACADDSYSLOG_1	EQU	1348
SYSENC_MACADDSYSLOG_2	EQU	1349
SYSENC_MACADDSYSLOG_3	EQU	1350
SYSENC_MACADDSYSLOG_4	EQU	1351
SYSENC_MACADDSYSLOG_5	EQU	1352
SYSENC_MACADDSYSLOG_6	EQU	1353
SYSENC_SNTPSERVERADDR_1	EQU	1343
SYSENC_SNTPSERVERADDR_2	EQU	1344
SYSENC_SNTPSERVERADDR_3	EQU	1345
SYSENC_SNTPSERVERADDR_4	EQU	1346
SYSENC_SYSLOGSERVERADDR_1	EQU	1338
SYSENC_SYSLOGSERVERADDR_2	EQU	1339
SYSENC_SYSLOGSERVERADDR_3	EQU	1340
SYSENC_SYSLOGSERVERADDR_4	EQU	1341
...
;ENC_MacAddSyslog(1)=0x00
	banksel	SYSENC_MACADDSYSLOG_1
	clrf	SYSENC_MACADDSYSLOG_1
;ENC_MacAddSyslog(2)=0x06
	movlw	6
	movwf	SYSENC_MACADDSYSLOG_2
;ENC_MacAddSyslog(3)=0x29
	movlw	41
	movwf	SYSENC_MACADDSYSLOG_3
;ENC_MacAddSyslog(4)=0x29
	movlw	41
	movwf	SYSENC_MACADDSYSLOG_4
;ENC_MacAddSyslog(5)=0x95
	movlw	149
	movwf	SYSENC_MACADDSYSLOG_5
;ENC_MacAddSyslog(6)=0x2F
	movlw	47
	movwf	SYSENC_MACADDSYSLOG_6
;ENC_SysLogServerAddr=192, 168, 0, 249
	movlw	low ENC_SYSLOGSERVERADDR
	movwf	FSR0L
	movlw	high ENC_SYSLOGSERVERADDR
	movwf	FSR0H
	movlw	4
	movwf	INDF0
	incf	FSR0L,F
...
;ENC28j60_syslog_sendmessage
	pagesel	ENC28J60_SYSLOG_SENDMESSAGE
	call	ENC28J60_SYSLOG_SENDMESSAGE
	pagesel	$
...
ENC28J60_SYSLOG_SENDMESSAGE
;T_enetpacketdest0 = ENC_MacAddSyslog(1)
	banksel	SYSENC_MACADDSYSLOG_1
	movf	SYSENC_MACADDSYSLOG_1,W
	banksel	SYSETHERBUFFER_1
	movwf	SYSETHERBUFFER_1
;T_enetpacketdest1 = ENC_MacAddSyslog(2)
	banksel	SYSENC_MACADDSYSLOG_2
	movf	SYSENC_MACADDSYSLOG_2,W
	banksel	SYSETHERBUFFER_2
	movwf	SYSETHERBUFFER_2
;T_enetpacketdest2 = ENC_MacAddSyslog(3)
	banksel	SYSENC_MACADDSYSLOG_3
	movf	SYSENC_MACADDSYSLOG_3,W
	banksel	SYSETHERBUFFER_3
	movwf	SYSETHERBUFFER_3
;T_enetpacketdest3 = ENC_MacAddSyslog(4)
	banksel	SYSENC_MACADDSYSLOG_4
	movf	SYSENC_MACADDSYSLOG_4,W
	banksel	SYSETHERBUFFER_4
	movwf	SYSETHERBUFFER_4
;T_enetpacketdest4 = ENC_MacAddSyslog(5)
	banksel	SYSENC_MACADDSYSLOG_5
	movf	SYSENC_MACADDSYSLOG_5,W
	banksel	SYSETHERBUFFER_5
	movwf	SYSETHERBUFFER_5
;T_enetpacketdest5 = ENC_MacAddSyslog(6)
	banksel	SYSENC_MACADDSYSLOG_6
	movf	SYSENC_MACADDSYSLOG_6,W
	banksel	SYSETHERBUFFER_6
...
;T_ip_srcaddr3 = ENC_IpAddr(4)
	...
	banksel	SYSETHERBUFFER_30
	movwf	SYSETHERBUFFER_30
;T_ip_destaddr0 = ENC_SysLogServerAddr(1)
	banksel	SYSENC_SYSLOGSERVERADDR_1
	movf	SYSENC_SYSLOGSERVERADDR_1,W
	banksel	SYSETHERBUFFER_31
	movwf	SYSETHERBUFFER_31
;T_ip_destaddr1 = ENC_SysLogServerAddr(2)
	banksel	SYSENC_SYSLOGSERVERADDR_2
	movf	SYSENC_SYSLOGSERVERADDR_2,W
	banksel	SYSETHERBUFFER_32
	movwf	SYSETHERBUFFER_32
;T_ip_destaddr2 = ENC_SysLogServerAddr(3)
	banksel	SYSENC_SYSLOGSERVERADDR_3
	movf	SYSENC_SYSLOGSERVERADDR_3,W
	banksel	SYSETHERBUFFER_33
	movwf	SYSETHERBUFFER_33
;T_ip_destaddr3 = ENC_SysLogServerAddr(4)
	banksel	SYSENC_SYSLOGSERVERADDR_4
	movf	SYSENC_SYSLOGSERVERADDR_4,W
	banksel	SYSETHERBUFFER_34
	movwf	SYSETHERBUFFER_34
;T_udp_srcport0 = 0X02
	movlw	2
...
;T_udp_srcport1 = 0X02
	movlw	2
	movwf	SYSETHERBUFFER_36
;T_udp_destport0 = 0X02                                        'port 514 = 0x0202
	movlw	2
	movwf	SYSETHERBUFFER_37
;T_udp_destport1 = 0X02
	movlw	2
	movwf	SYSETHERBUFFER_38
;T_udp_len0 = 0X00
...
;T_udp_data10 = " "
	movlw	32
	movwf	SYSETHERBUFFER_53
;T_udp_data11 = "8"
	movlw	56
	movwf	SYSETHERBUFFER_54
;T_udp_data12 = " "
	movlw	32
...
;T_udp_data19 = "5"
	movlw	53
	movwf	SYSETHERBUFFER_62
;T_udp_data20 = ":"
	movlw	58
	movwf	SYSETHERBUFFER_63
;T_udp_data21 = "5"
	movlw	53
	movwf	SYSETHERBUFFER_64
;T_udp_data22 = "4"
	movlw	52
	movwf	SYSETHERBUFFER_65
;T_udp_data23 = " "
	movlw	32
	movwf	SYSETHERBUFFER_66
;T_udp_data24 = "E"
	movlw	69
	movwf	SYSETHERBUFFER_67
;T_udp_data25 = "l"
	movlw	108
	movwf	SYSETHERBUFFER_68
;T_udp_data26 = "i"
	movlw	105
	movwf	SYSETHERBUFFER_69
;T_udp_data27 = "t"
	movlw	116
	movwf	SYSETHERBUFFER_70
;ENC28j60_Ip_header_checksum
	banksel	STATUS
	pagesel	ENC28J60_IP_HEADER_CHECKSUM
	call	ENC28J60_IP_HEADER_CHECKSUM
