...
#include "usb_device_cdc.h"
    ...
    #define CDC_OUT_DATA_BUFFER_ADDRESS_TAG
    #define CDC_CONTROL_BUFFER_ADDRESS_TAG
#endif

#if !defined(CDC_IN_DATA_BUFFER_ADDRESS_TAG) || !defined(CDC_OUT_DATA_BUFFER_ADDRESS_TAG) || !defined(CDC_CONTROL_BUFFER_ADDRESS_TAG)
...
/** V A R I A B L E S ********************************************************/
volatile unsigned char cdc_data_tx[CDC_DATA_IN_EP_SIZE] CDC_IN_DATA_BUFFER_ADDRESS_TAG;
volatile unsigned char cdc_data_rx[CDC_DATA_OUT_EP_SIZE] CDC_OUT_DATA_BUFFER_ADDRESS_TAG;
